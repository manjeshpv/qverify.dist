    ...
    _createClass(CompanyUsersComponent, [{
      ...
      value: function $onInit() {
        ...
        this.$scope.gridOpts = {
          ...
          columnDefs: [{ name: 'User', field: 'name' }]
        };
      }
    }, {
      key: 'openRegister',
...
(function () {
  ...
  function CompanyComponent($log, QverifyConnection, $scope, $stateParams, $state, URLS) {
    ...
    $scope.gridOpts = {
      ...
      }, { name: 'Company', field: 'name' }, { name: 'Address', field: 'address' }, { name: 'Created on', field: 'created_on', type: 'date', cellFilter: 'date:"dd-MM-yy "' }]
...
(function () {
  ...
  function CreationComponent($log, QverifyConnection, toaster) {
    ...
    qverifyConnection.fetchState().then(function (states) {
      vm.State = states;
    });
    qverifyConnection.fetchPin().then(function (pins) {
      vm.Pin = pins;
    });
...
(function () {
  function OverviewComponent($log, QverifyConnection, $scope) {
    ...
    $scope.gridOpts = {
      //data:myData,
      enableFiltering: true,
      columnDefs: [{ name: 'Id', field: 'Case.id' }, { name: 'Client', field: 'Case.User.name' }, { name: 'Vendor', field: 'User.name' }, { name: 'Case', field: 'Case.name' }, { name: 'Status', field: 'Case.Status.name' }, { name: 'Created On', field: 'created_on', type: 'date', cellFilter: 'date:"dd-MM-yy "' }]
    };
...
$templateCache.put("app/main/main.html","<header id=\"banner\" class=\"hero-unit\"><div class=\"container\"><h1>\'Allo, \'Allo!</h1><p class=\"lead\">Kick-start your next web app with Angular Fullstack</p><img src=\"assets/images/yeoman-1cab7d4d37.png\" alt=\"I\'m Yeoman\"/></div></header><div class=\"container\"><div class=\"row\"><div class=\"col-lg-12\"><h1 class=\"page-header\">Features:</h1><ul ng-repeat=\"thing in $ctrl.awesomeThings\" class=\"nav nav-tabs nav-stacked col-md-4 col-lg-4 col-sm-6\"><li><a href=\"#\" uib-tooltip=\"{{thing.info}}\">{{thing.name}}</a></li></ul></div></div></div>");
