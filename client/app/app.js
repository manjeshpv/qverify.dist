...
(function () {
  ...
  function NewcompanyComponent(QverifyConnection, toaster, $state) {
    ...
    vm.createCompany = function (company) {
      ...
      vm.create = function () {
        qverifyConnection.createCompany(vm.company).then(function () {
          $state.go("company");
        });
      };
    };
