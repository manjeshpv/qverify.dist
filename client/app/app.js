...
(function () {
  function OverviewComponent($log, QverifyConnection, $scope, Restangular) {
    ...
    $scope.gridOpts = {
      ...
      { name: 'Client', field: 'User.name' }, { name: 'Vendor', field: 'Allocations.User.name' }, { name: 'Case', field: 'name' }, { name: 'Status', field: 'Status.name' }, { name: 'Created On', field: 'created_at', cellFilter: 'date:"dd-MM-yy "' }]
    };
