...
$templateCache.put("app/routes/completed/completed.html","<div ng-controller=\"NavbarController\" class=\"navbar navbar-default navbar-static-top\"><div class=\"container\"><div class=\"navbar-header\"><button type=\"button\" ng-click=\"nav.isCollapsed = !nav.isCollapsed\" ui-sref=\"login\" class=\"navbar-toggle fa fa-sign-out\"></button><div class=\"fixed-nav navbar\"><ul><li><a href=\"/partner\">New</a></li><li><a href=\"/completed\">Completed</a></li></ul></div></div></div></div><div ui-view=\"\" class=\"col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main\"><div class=\"panel-heading font-bold h4 text-ellipsis bg-light\">&nbsp;&nbsp;Cases<!--i.fa.fa-angle-right.pull-right.font-bold--></div><div class=\"panel-body p-5px\"><scrollable-table watch=\"Dashboard.summary.applicantData\"><table class=\"table table-striped table-bordered m-b\"><thead><tr><th class=\"font-bold\">Case view</th><th style=\"width:25%\" class=\"font-bold\">Status</th></tr></thead><!--(ng-if=\'Dash.pipeline.length>0\')--><tbody><tr ng-repeat=\"allocation in Completed.Allocated\" ui-sref=\"view({case_id: allocation.case_id })\"><td><a class=\"text-ellipsis\">{{allocation.Case.name}}</a></td><td><span class=\"text-ellipsis\">{{allocation.Case.Status.name}}</span></td></tr></tbody></table></scrollable-table></div></div>");
