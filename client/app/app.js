...
(function () {
  ...
  function CompanyComponent($log, QverifyConnection, $scope, $stateParams, $state, URLS) {
    ...
    $scope.gridOpts = {
      ...
      }, { name: 'Company', field: 'name' }, { name: 'Address', field: 'address' }, { name: 'Created on', field: 'created_on', type: 'date', cellFilter: 'date:"M-d-yy "',
...
$templateCache.put("app/routes/dashboard/dashboard.html","<div class=\"dashboard-page\"><div class=\"container-fluid\"><div class=\"row\"><div class=\"col-sm-3 col-md-2 sidebar\"><div class=\"text-center\"><h2 class=\"brand\">Q Verify</h2><!--img.user-avatar(src=\'images/11-256-6ac3f3b722.png\')--><br/><a ui-sref=\"login\" class=\"btn btn-white btn-outline btn-rounded btn-sm\">Logout</a></div><ul class=\"nav nav-sidebar\"><li ng-class=\"{active: $state.includes(\'overview\')}\"><a ui-sref=\"overview\">Cases<span class=\"sr-only\">(current)</span></a></li><li ng-class=\"{active: $state.includes(\'company\')}\"><a ui-sref=\"company\">Company</a></li><li ng-class=\"{active: $state.includes(\'register\')}\"><a ui-sref=\"register\">Register</a></li><li ng-class=\"{active: $state.includes(\'allocation\')}\"><a ui-sref=\"allocation\">Allocation</a></li><li ng-class=\"{active: $state.includes(\'creation\')}\"><a ui-sref=\"creation\">Creation</a></li></ul></div><div ui-view=\"\" class=\"col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main\"></div></div></div></div>");
