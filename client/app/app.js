...
(function () {
  function OverviewComponent($log, QverifyConnection, $scope) {
    ...
    $scope.gridOpts = {
      //data:myData,
      enableFiltering: true,
      columnDefs: [{ name: 'Client', field: 'Case.User.name' }, { name: 'Vendor', field: 'User.name' }, { name: 'Case', field: 'Case.name' }, { name: 'Status', field: 'Case.Status.name' }]
    };
