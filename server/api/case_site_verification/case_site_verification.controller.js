...
function index(req, res) {
  return _sqldb.CaseSiteVerification.findAll().then(respondWithResult(res)).catch(handleError(res));
}

// Gets a single CaseSiteVerification from the DB
function show(req, res) {
  return _sqldb.CaseSiteVerification.find({
    where: {
      _id: req.params.id
    }
...
function create(req, res) {
  return _sqldb.CaseSiteVerification.create(req.body).then(function (caseTypeObj) {
...
//# sourceMappingURL=case_site_verification.controller.js.map
